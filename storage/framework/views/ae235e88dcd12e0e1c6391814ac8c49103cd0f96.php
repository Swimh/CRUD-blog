...
<?php $component->withAttributes([]); ?>
        <main class="max-w-6xl mx-auto mt-6 lg:mt-10 space-y-6 "> 
            <form method="post" action="<?php echo e(route('create.category'), true); ?>" enctype="multipart/form-data" class="w-full max-w-lg  m-auto">
                <?php echo csrf_field(); ?>
...
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?><?php /**PATH C:\laragon\www\blog\resources\views/add-category.blade.php ENDPATH**/ ?>