<x-layout>
    ...
    <main class="max-w-6xl mx-auto mt-6 lg:mt-20 space-y-6 "> 
        <form method="post" action="/register" class="w-full max-w-lg  m-auto">
        @csrf
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
            ...
            <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-name" type="text" name="name" placeholder="Name">
            ...
            <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-user-name" type="text" name="username" placeholder="Username">
            </div>
        </div>
        <div class="flex flex-wrap -mx-3 mb-6">
